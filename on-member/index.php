            ...
            <table class="table table-condensed">
              <thead>
                <tr>
                  ...
                  <th>Sub Kegiatan</th>
                  <th>Nilai</th>
                  <th>SK UNIDA Siman</th>
                  <th>SK UNIDA Cabang</th>
                  <th>Id Jenis Kegiatan</th>
                </tr>
              </thead>
              <?php
              $query = "SELECT * FROM simak_kegiatan"; 
              ...
              while($data = mysqli_fetch_array($sql)){ ?>
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $data['sk_unida_siman'];?></td>
                    <td><?php echo $data['sk_unida_cabang'];?></td>
                    <td><?php echo $data['id_jenis_kegiatan'];?></td>
                  </tr>
                </tbody>
              <?php } ?>
            </table>
